...
class Mutt < Formula
  ...
  def options
    [
      ...
      ['--gmail-search-patch', "Apply gmail server search patch"],
    ]
  end
  ...
  def patches
    urls = [
      ...
      ['--gmail-search-patch', 'http://people.spodhuis.org/phil.pennock/software/mutt-patches/patch-mutt-gmailcustomsearch.v1'],
    ]
